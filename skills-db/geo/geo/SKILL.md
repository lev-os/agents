...
|---|-------|-----------|---------|
| 1 | geo-audit | `skills-db/geo/geo-audit/` | Full audit orchestration and scoring |
| 2 | geo-citability | `skills-db/geo/geo-citability/` | Passage-level AI citation readiness |
| 3 | geo-crawlers | `skills-db/geo/geo-crawlers/` | AI crawler access and robots.txt |
| 4 | geo-llmstxt | `skills-db/geo/geo-llmstxt/` | llms.txt standard analysis and generation |
| 5 | geo-brand-mentions | `skills-db/geo/geo-brand-mentions/` | Brand presence on AI-cited platforms |
| 6 | geo-platform-optimizer | `skills-db/geo/geo-platform-optimizer/` | Platform-specific AI search optimization |
| 7 | geo-schema | `skills-db/geo/geo-schema/` | Structured data for AI discoverability |
| 8 | geo-technical | `skills-db/geo/geo-technical/` | Technical SEO foundations |
| 9 | geo-content | `skills-db/geo/geo-content/` | Content quality and E-E-A-T |
| 10 | geo-report | `skills-db/geo/geo-report/` | Client-ready deliverable generation |
...
3. Execute the PDF generator: `python3 ~/.agents/skills-db/geo/geo/scripts/generate_pdf_report.py data.json GEO-REPORT.pdf`
