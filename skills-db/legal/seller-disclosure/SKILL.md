...
description: >-
  ...
  encumbrances, and neighborhood conditions. Enforces state-specific
  statutory compliance and federal lead-based paint requirements.
  Trigger keywords: "seller disclosure", "property condition statement",
  "residential transfer disclosure", "seller disclosure statement".
tags:
  - agreement
  - drafting
  - transactional
