...
1. **Formation documents** — articles/certificate confirming exact legal entity name with designator (Inc., Corp., Ltd., LLC)
2. **Bylaws or operating agreement** — current, with amendments noted (becomes Exhibit A)
3. **Board resolutions or written consents** — adoption dates; confirm notice, quorum, and voting thresholds
4. **Officer/director roster** — full legal names, exact titles, election/appointment dates
5. **Third-party requirements** — bank checklists, prescribed forms, specific certifications (FinCEN, TIN, sanctions)
6. **Transaction description** — purpose, named recipient, single vs. multi-closing
