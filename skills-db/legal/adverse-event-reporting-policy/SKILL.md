...
description: >
  ...
  multi-jurisdictional overlays (EMA, PMDA, Health Canada). Covers
  seriousness/causality frameworks, expedited reporting timelines, roles,
  documentation standards, training mandates, and QA mechanisms. Use when
  drafting or updating an adverse event reporting policy, pharmacovigilance
  policy, AE/SAE reporting SOP, or safety reporting framework for a
  pharmaceutical company, CRO, biotech, or clinical research institution.
metadata:
  author: casemark
  practice_areas:
    - Regulatory
