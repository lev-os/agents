...
description: >-
  ...
  and grounds for partition in kind or by sale. Trigger when the user needs a
  partition action, co-owner dispute complaint, tenant-in-common or joint-tenancy
  division, or court-ordered sale of real property.
tags:
  - drafting
  - litigation
  - pleading
