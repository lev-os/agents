...
description: >
  ...
  Covers safe harbor selection, doing-business tests, residency verification,
  advertising controls, resale restrictions, integration analysis, and blue sky
  registration. Trigger when the user mentions intrastate offering, Rule 147,
  Rule 147A, registration by qualification, single-state offering, Section
  3(a)(11), state-only fundraising, in-state investor requirements, resale
  restriction legends, or says "we're only raising in one state."
---
