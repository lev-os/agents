...
description: >-
  ...
  and closeout. Use when drafting or revising a work letter, tenant
  improvement allowance terms, build-out procedures, or a lease exhibit for
  tenant improvements. Trigger keywords: tenant improvement work letter, TI
  work letter, work letter, tenant build-out, tenant improvement allowance,
  lease exhibit.
tags:
  - agreement
  - drafting
