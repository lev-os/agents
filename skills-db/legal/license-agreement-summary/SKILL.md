...
description: >-
  ...
  management, risk allocation, and termination. Use when summarizing IP
  license agreements, extracting deal terms, or flagging licensing risks.
  Trigger keywords: license agreement, IP license, royalty, exclusivity,
  field of use, sublicense, audit, termination.
tags:
  - agreement
  - summarization
  - summary
...
- Do not provide legal advice; summarize and flag issues only.
