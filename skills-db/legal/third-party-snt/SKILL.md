...
description: >
  ...
  benefits without triggering Medicaid payback obligations. Use when drafting
  supplemental needs trusts, third-party SNTs, estate planning disability
  trusts, special needs trust agreements, or any trust intended to preserve
  SSI/Medicaid eligibility for a disabled beneficiary using third-party assets.
  Also trigger when the user asks about permissible SNT distributions, in-kind
  support and maintenance rules, ABLE account coordination, or remainder
  beneficiary planning for disability trusts.
tags:
  - agreement
  - drafting
  - transactional
