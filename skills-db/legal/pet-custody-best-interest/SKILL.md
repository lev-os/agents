...
description: >
  ...
  (well-being statute, hybrid equitable, or pure property), builds distinct
  ownership/caregiving/control evidentiary threads, applies welfare factors
  with adversarial awareness, and generates enforceable allocation
  recommendations. Use when drafting pet custody analyses, animal allocation
  memos, pet possession briefs, or when a user asks about dividing pets in
  a divorce, breakup, or cohabitation dissolution.
tags:
  - analysis
  - drafting
  - litigation
