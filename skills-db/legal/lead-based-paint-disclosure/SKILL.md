...
description: >-
  ...
  Covers seller/landlord knowledge statements, record attachments, EPA pamphlet
  delivery, purchaser inspection option, acknowledgments, and agent
  certifications. Use when preparing a lead-based paint disclosure, lead hazard
  notice, or pre-1978 property disclosure; trigger keywords: lead-based paint,
