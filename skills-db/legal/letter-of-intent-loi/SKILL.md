...
description: >-
  ...
  intent from enforceable obligations and defines deal structure, key
  economics, and closing path. Use when converting deal terms into a
  preliminary transaction document. Trigger keywords: "LOI", "letter of
  intent", "M&A LOI", "merger term sheet", "no-shop", "exclusivity",
  "deal letter".
---
