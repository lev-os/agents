...
- Full legal name, title/role, organization
- Contact info (email, phone)
- Relationship to evaluated entity (client, co-counsel, subcontractor, COR, etc.)
- Duration of professional relationship
- Professional credentials / bar number (if attorney)

### 2. Engagement Details

- Contract/matter number
- Matter type (litigation, transactional, regulatory, advisory)
...
- Key deliverables, final disposition/outcome
- Subcontractors involved (if applicable)
...
- Performance metrics or scorecards
- Correspondence documenting issues or commendations
- Third-party references with contact authorization
- Final deliverable acceptance records
...
- Truth and accuracy attestation
- Consequence disclosure for false/misleading statements (per applicable policy)
- Authorization limiting use to stated evaluation purpose
- Signature, printed name, title, and date fields
