...
description: >-
  ...
  verification, and proof of service. Use when preparing a lis pendens, notice
  of pending action, or recording notice tied to title or possession claims.
  Trigger: lis pendens, notice of pending action, quiet title, specific
  performance, foreclosure, partition, lien enforcement, expungement.
---
