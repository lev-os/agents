...
description: >-
  ...
  debt/tax payment, specific bequests, the central pour-over clause, and
  execution formalities with self-proving affidavit. Use when drafting
  pour-over wills, testamentary trust transfers, estate planning safety nets,
  or residuary estate instruments. Trigger keywords: pour-over will, residuary
  estate, revocable trust, testamentary transfer, UTATA, personal
  representative, guardian nomination, self-proving affidavit.
tags:
  - agreement
  - drafting
  - transactional
