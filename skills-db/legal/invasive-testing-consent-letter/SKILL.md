...
description: >
  ...
  access, due diligence, or purchase and sale agreement. Use this skill when a
  counterparty requests soil borings, test pits, groundwater wells, soil vapor
  sampling, or other intrusive ESA activities. Trigger on keywords including
  "Phase II," "invasive testing," "environmental site assessment," "ESA,"
  "borings," "test pits," "monitoring wells," "restoration bond," "PLL insurance,"
  "access agreement," "consent letter," "IDW handling," or "environmental due
  diligence." Even if the user just says "they want to do borings on the site"
  or "draft consent for Phase II," use this skill.
tags:
  - drafting
  - letter
  - regulatory
