...
description: >
  ...
  appropriateness, and document coordination. Use when the user asks about advance
  directive vs. POLST, living will vs. DNR, which document EMS follows, POLST vs.
  MOLST vs. POST, whether a healthy person needs a POLST, or document coordination
  in elder law, estate planning, or serious illness contexts.
---
