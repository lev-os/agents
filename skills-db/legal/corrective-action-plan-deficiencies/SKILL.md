...
description: >-
  ...
  root-cause analysis, remediation steps, accountability, milestones,
  monitoring, and validation. Trigger when the user mentions CAP, plan of
  correction, deficiency citation, scope/severity remediation, correction
  timeline, or sustainability monitoring for CMS, state, or Joint Commission
  findings.
tags:
  - drafting
  - memo
