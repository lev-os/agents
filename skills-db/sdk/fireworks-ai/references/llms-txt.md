...
**URL:** llms-txt#create-from-source-job:
...
**URL:** llms-txt#how-to-check-if-a-model-is-available-on-serverless?
...
**URL:** llms-txt#create-batch-inference-job
...
**URL:** llms-txt#deploy-fine-tuned-model-using-multi-lora-(sharing-base-deployment)
...
**URL:** llms-txt#create-with-full-shape-id
...
**URL:** llms-txt#generate-or-edit-an-image-with-flux.1-kontext
...
**URL:** llms-txt#export-billing-metrics-to-csv
...
**URL:** llms-txt#firectl-dpo-job-resume
...
**URL:** llms-txt#get-evaluation-job
...
**URL:** llms-txt#firectl-account-list
...
**URL:** llms-txt#create-reinforcement-fine-tuning-job
...
**URL:** llms-txt#generate-deterministic-hash-from-user_id
...
**URL:** llms-txt#firectl-dataset-download
...
**URL:** llms-txt#execute-one-training-step-for-keep-alive-reinforcement-fine-tuning-step
...
**URL:** llms-txt#get-model-download-endpoint
...
**URL:** llms-txt#reserved-capacity
...
**URL:** llms-txt#how-does-billing-and-scaling-work-for-on-demand-gpu-deployments?
...
**URL:** llms-txt#get-evaluator-upload-endpoint
...
**URL:** llms-txt#fine-tuning-overview
...
**URL:** llms-txt#get-an-existing-batch-inference-job
...
**URL:** llms-txt#monitor-training-progress
...
**URL:** llms-txt#warning:-it-has-a-process-wide-effect
...
**URL:** llms-txt#the-dataset-is-now-available-on-fireworks-and-ready-for-fine-tuning
...
**URL:** llms-txt#how-do-i-control-output-image-sizes-when-using-sdxl-controlnet?
...
**URL:** llms-txt#embeddings-&-reranking
...
**URL:** llms-txt#create-with-a-shape-(shorthand)
...
**URL:** llms-txt#validate-evaluator-upload
...
**URL:** llms-txt#firectl-evaluator-revision-get
...
**URL:** llms-txt#synchronous-usage
...
**URL:** llms-txt#✅-only-add-time-when-the-query-actually-needs-it
...
**URL:** llms-txt#firectl-evaluator-revision-delete
...
**URL:** llms-txt#create-oidc-identity-provider-with-multiple-domains
...
**URL:** llms-txt#asynchronous-usage
...
**URL:** llms-txt#firectl-deployment-scale
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-resume
...
**URL:** llms-txt#firectl-secret-list
...
**URL:** llms-txt#get-dataset-upload-endpoint
...
**URL:** llms-txt#create-base-model
...
**URL:** llms-txt#example:-daily-export-with-dated-filename
...
**URL:** llms-txt#the-new-model-is-now-available-at-job.output_model
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-get
...
**URL:** llms-txt#firectl-deployment-update
...
**URL:** llms-txt#check-deployment-status
...
**URL:** llms-txt#define-tools-to-enable-interleaved-thinking
...
**URL:** llms-txt#how-much-does-fireworks-cost?
...
**URL:** llms-txt#client-updated-state:
...
**URL:** llms-txt#exporting-billing-metrics
...
**URL:** llms-txt#now,-continue-the-conversation
...
**URL:** llms-txt#resume-rlor-trainer-job
...
**URL:** llms-txt#create-supervised-fine-tuning-job
...
**URL:** llms-txt#rate-limits-&-quotas
...
**URL:** llms-txt#deploy-a-fine-tuned-model-with-on-demand-deployment
...
**URL:** llms-txt#if-your-deployment-is-running-qwen-2.5-72b-instruct
...
**URL:** llms-txt#firectl-secret-get
...
**URL:** llms-txt#supervised-fine-tuning---text
...
**URL:** llms-txt#firectl-deployment-get
...
**URL:** llms-txt#get-evaluator-build-log-endpoint
...
**URL:** llms-txt#firectl-batch-inference-job-get
...
**URL:** llms-txt#create-dataset-referencing-your-gcs-bucket
...
**URL:** llms-txt#firectl-supervised-fine-tuning-job-create
...
**URL:** llms-txt#create-batch-request
...
**URL:** llms-txt#firectl-model-get
...
**URL:** llms-txt#(this-would-be-your-rollout-generation-logic)
...
**URL:** llms-txt#get-first-5-rows-as-a-list
...
**URL:** llms-txt#firectl-model-download
...
**URL:** llms-txt#flux-image-generation
...
**URL:** llms-txt#perform-reinforcement-learning-step
...
**URL:** llms-txt#configure-fireworks-logging-sink-once-at-startup
...
**URL:** llms-txt#speculative-decoding
...
**URL:** llms-txt#create-a-new-llm-with-performance-metrics-enabled
...
**URL:** llms-txt#custom-few-shot-prompt-template
...
**URL:** llms-txt#is-prompt-caching-billed-differently-for-serverless-models?
...
**URL:** llms-txt#firectl-quota-update
...
**URL:** llms-txt#compute-ratio-for-consistent-routing
...
**URL:** llms-txt#firectl-secret-update
...
**URL:** llms-txt#get-evaluator-source-code-endpoint
...
**URL:** llms-txt#what’s-the-supported-throughput?
...
**URL:** llms-txt#create-reinforcement-fine-tuning-step
...
**URL:** llms-txt#validate-model-upload
...
**URL:** llms-txt#what-should-i-do-if-i-can't-access-my-company-account-after-being-invited-when-i-already-have-a-personal-account?
...
**URL:** llms-txt#cancel-reinforcement-fine-tuning-job
...
**URL:** llms-txt#direct-preference-optimization
...
**URL:** llms-txt#start-using-the-deployment-immediately---no-.apply()-needed
...
**URL:** llms-txt#firectl-deployment-undelete
...
**URL:** llms-txt#remote-environment-setup
...
**URL:** llms-txt#list-all-models

---

## firectl dataset create

**URL:** llms-txt#firectl-dataset-create
...
**URL:** llms-txt#search-by-name-(partial-match)
...
**URL:** llms-txt#delete-batch-inference-job
...
**URL:** llms-txt#firectl-deployed-model-list
...
**URL:** llms-txt#create-dataset-and-sync-it-to-fireworks
...
**URL:** llms-txt#firectl-model-prepare
...
**URL:** llms-txt#firectl-supervised-fine-tuning-job-get
...
**URL:** llms-txt#advanced-usage-with-optional-parameters
...
**URL:** llms-txt#third-turn---ask-for-another-calculation
...
**URL:** llms-txt#connect-to-your-existing-dedicated-deployment
...
**URL:** llms-txt#fourth-turn---include-the-third-assistant-message-and-tool-response
...
**URL:** llms-txt#use-in-fine-tuning-job
...
**URL:** llms-txt#create-dataset-from-a-jsonl-file
...
**URL:** llms-txt#create-dataset-from-a-jsonl-string
...
**URL:** llms-txt#get-dataset-download-endpoint
...
**URL:** llms-txt#use-the-improved-model
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-create
...
**URL:** llms-txt#perform-a-reinforcement-learning-step
...
**URL:** llms-txt#initialize-using-environment-variables
...
**URL:** llms-txt#firectl-model-list
...
**URL:** llms-txt#do-you-support-auto-scaling?
...
**URL:** llms-txt#list-deployment-shapes
...
**URL:** llms-txt#are-there-discounts-for-bulk-usage?
...
**URL:** llms-txt#how-does-billing-work-for-on-demand-deployments?
...
**URL:** llms-txt#delete-a-deployment
...
**URL:** llms-txt#what-email-does-linkedin-authentication-use?
...
**URL:** llms-txt#create-embeddings
...
**URL:** llms-txt#list-all-batch-inference-jobs
...
**URL:** llms-txt#client-side-performance-optimization
...
**URL:** llms-txt#which-model-should-i-use?
...
**URL:** llms-txt#build-sdk-introduction
...
**URL:** llms-txt#create-dataset-referencing-your-s3-bucket
...
**URL:** llms-txt#upload-dataset-files
...
**URL:** llms-txt#firectl-identity-provider-get
...
**URL:** llms-txt#firectl-quota-get
...
**URL:** llms-txt#✅-good:-static-content-first
...
**URL:** llms-txt#firectl-set-api-key
...
**URL:** llms-txt#firectl-user-list
...
**URL:** llms-txt#prepare-model-for-different-precisions
...
**URL:** llms-txt#build-with-fireworks-ai
...
**URL:** llms-txt#user-query-goes-last
...
**URL:** llms-txt#list-evaluation-jobs
...
**URL:** llms-txt#undelete-deployment
...
**URL:** llms-txt#define-your-schema
...
**URL:** llms-txt#firectl-batch-inference-job-create
...
**URL:** llms-txt#firectl-user-delete
...
**URL:** llms-txt#download-entire-lineage-chain-(only-for-batch-inference-continuation-jobs)
...
**URL:** llms-txt#firectl-dataset-list
...
**URL:** llms-txt#example-rollout-generation-function-with-concurrent-generation
...
**URL:** llms-txt#configure-fireworks-tracing-handler-globally
...
**URL:** llms-txt#create-a-new-llm-with-different-deployment-type
...
**URL:** llms-txt#get-deployment-shape-version
...
**URL:** llms-txt#warm-start-from-fine-tuned-models
...
**URL:** llms-txt#firectl-model-upload
...
**URL:** llms-txt#how-do-credits-work?
...
**URL:** llms-txt#how-do-i-close-my-fireworks.ai-account?
...
**URL:** llms-txt#delete-a-batch-inference-job
...
**URL:** llms-txt#run-the-async-reinforcement-learning-workflow
...
**URL:** llms-txt#view-shape-details
...
**URL:** llms-txt#print-tool-call-from-the-third-response
...
**URL:** llms-txt#training-overview
...
**URL:** llms-txt#get-reinforcement-fine-tuning-step
...
**URL:** llms-txt#firectl-billing-list-invoices
...
**URL:** llms-txt#firectl-user-update
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-delete
...
**URL:** llms-txt#initialize-with-fireworks-parameters
...
**URL:** llms-txt#second-turn---include-the-first-assistant-message
...
**URL:** llms-txt#firectl-supervised-fine-tuning-job-list
...
**URL:** llms-txt#how-does-the-system-scale?
...
**URL:** llms-txt#firectl-quota-list
...
**URL:** llms-txt#querying-dedicated-deployments
...
**URL:** llms-txt#how-does-autoscaling-affect-my-costs?
...
**URL:** llms-txt#synchronous-streaming
...
**URL:** llms-txt#firectl-reservation-get
...
**URL:** llms-txt#firectl-batch-inference-job-delete
...
**URL:** llms-txt#firectl-api-key-create
...
**URL:** llms-txt#firectl-credit-redemption-redeem
...
**URL:** llms-txt#check-if-reasoning_content-from-both-first-and-third-turns-are-in-the-raw-prompt
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-cancel
...
**URL:** llms-txt#get-generated-image-from-flux.1-kontext
...
**URL:** llms-txt#video-&-audio-inputs
...
**URL:** llms-txt#validate-dataset-upload
...
**URL:** llms-txt#firectl-api-key-list
...
**URL:** llms-txt#use-raw-filter-for-advanced-queries
...
**URL:** llms-txt#number-of-reinforcement-learning-steps

---

## firectl deployment-shape-version get

**URL:** llms-txt#firectl-deployment-shape-version-get
...
**URL:** llms-txt#firectl-deployment-list
...
**URL:** llms-txt#are-there-extra-fees-for-serving-fine-tuned-models?
...
**URL:** llms-txt#firectl-secret-create
...
**URL:** llms-txt#serverless-quickstart
...
**URL:** llms-txt#are-there-slas-for-serverless?
...
**URL:** llms-txt#if-your-deployment-is-running-llama-3.2-3b-instruct
...
**URL:** llms-txt#configure-traffic-fraction-(e.g.,-20%-to-new-deployment)
...
**URL:** llms-txt#initialize-base-model
...
**URL:** llms-txt#get-supervised-fine-tuning-job
...
**URL:** llms-txt#get-reinforcement-fine-tuning-job
...
**URL:** llms-txt#first-turn---get-a-response-with-reasoning_content
...
**URL:** llms-txt#server-initial-message:
...
**URL:** llms-txt#exporting-metrics
...
**URL:** llms-txt#create-a-batch-inference-job
...
**URL:** llms-txt#✅-keep-system-prompt-static,-add-time-context-to-user-message
...
**URL:** llms-txt#get-model-upload-endpoint
...
**URL:** llms-txt#client-initial-state:
...
**URL:** llms-txt#verify-we-got-reasoning_content
...
**URL:** llms-txt#why-might-my-account-be-suspended-even-with-remaining-credits?
...
**URL:** llms-txt#this-will-fail-because-the-previous-response-was-not-stored
...
**URL:** llms-txt#check-if-the-model-wants-to-call-a-function
...
**URL:** llms-txt#performance-benchmarking
...
**URL:** llms-txt#get-deployment-shape
...
**URL:** llms-txt#firectl-dpo-job-cancel
...
**URL:** llms-txt#firectl-credit-redemption-list
...
**URL:** llms-txt#firectl-reinforcement-fine-tuning-job-list
...
**URL:** llms-txt#firectl-billing-export-metrics
...
**URL:** llms-txt#weighted-training
...
**URL:** llms-txt#firectl-evaluator-revision-list
...
**URL:** llms-txt#apply-base-deployment-configuration-to-fireworks
...
**URL:** llms-txt#firectl-dataset-delete
...
**URL:** llms-txt#i-have-multiple-fireworks-accounts.-when-i-try-to-login-with-google-on-fireworks'-web-ui,-i'm-getting-signed-into-the-wrong-account.-how-do-i-fix-this?
...
**URL:** llms-txt#firectl-identity-provider-list
...
**URL:** llms-txt#get-first-10-rows-as-a-new-dataset
...
**URL:** llms-txt#basic-usage-with-required-parameters
...
**URL:** llms-txt#streaming-transcription
...
**URL:** llms-txt#scale-deployment-to-a-specific-number-of-replicas-or-to-zero
...
**URL:** llms-txt#deployments-quickstart
...
**URL:** llms-txt#extract-and-display-the-raw-prompt-that-was-sent-to-the-model
...
**URL:** llms-txt#list-all-deployments
...
**URL:** llms-txt#server-continuous-message:
...
**URL:** llms-txt#check-batch-status
...
**URL:** llms-txt#output:-{"winner":-"barack-obama"}
...
**URL:** llms-txt#delete-reinforcement-fine-tuning-step
...
**URL:** llms-txt#create-saml-identity-provider
...
**URL:** llms-txt#how-does-billing-and-credit-usage-work?
...
**URL:** llms-txt#list-supervised-fine-tuning-jobs
...
**URL:** llms-txt#create-dataset-from-a-list-of-examples
...
**URL:** llms-txt#check-for-bad-states-during-training
...
**URL:** llms-txt#force-a-specific-tool
...
**URL:** llms-txt#firectl-model-delete
...
**URL:** llms-txt#firectl-dataset-get
...
**URL:** llms-txt#build-the-complete-prompt

---

## How many tokens per image?

**URL:** llms-txt#how-many-tokens-per-image?
...
**URL:** llms-txt#add-dynamic-content-at-the-end
...
**URL:** llms-txt#get-updated-job-status
...
**URL:** llms-txt#there’s-a-model-i-would-like-to-use-that-isn’t-available-on-fireworks.-can-i-request-it?
...
**URL:** llms-txt#create-completion
...
**URL:** llms-txt#audit-&-access-logs
...
**URL:** llms-txt#firectl-deployment-create
...
**URL:** llms-txt#does-fireworks-support-custom-base-models?
...
**URL:** llms-txt#firectl-dataset-update
...
**URL:** llms-txt#list-batch-inference-jobs
...
**URL:** llms-txt#generate-an-image-with-flux.1-[schnell]-fp8
...
**URL:** llms-txt#what-email-does-github-authentication-use?
...
**URL:** llms-txt#firectl-dpo-job-delete
...
**URL:** llms-txt#create-dataset-from-existing-id
...
**URL:** llms-txt#update-deployment
...
**URL:** llms-txt#do-you-provide-notice-before-removing-model-availability?
...
**URL:** llms-txt#deploying-fine-tuned-models
...
**URL:** llms-txt#are-there-any-quotas-for-serverless?
...
**URL:** llms-txt#track-deployment-in-web-dashboard
...
**URL:** llms-txt#mlops-&-observability
...
**URL:** llms-txt#firectl-batch-inference-job-list
...
**URL:** llms-txt#use-in-fine-tuning-job-with-iam-role
...
**URL:** llms-txt#delete-supervised-fine-tuning-job
...
**URL:** llms-txt#model-=-"accounts/fireworks/models/minimax-m2"

---

## firectl supervised-fine-tuning-job cancel

**URL:** llms-txt#firectl-supervised-fine-tuning-job-cancel
...
**URL:** llms-txt#training-guide:-ui
...
**URL:** llms-txt#apply-deployment-configuration-to-fireworks

---

## List available shapes

**URL:** llms-txt#list-available-shapes
...
**URL:** llms-txt#firectl-model-load-lora
...
**URL:** llms-txt#create-evaluation-job
...
**URL:** llms-txt#firectl-user-create
...
**URL:** llms-txt#remote-agent-quickstart
...
**URL:** llms-txt#does-the-api-support-batching-and-load-balancing?
...
**URL:** llms-txt#list-deployment-shapes-versions
...
**URL:** llms-txt#inference-error-codes
...
**URL:** llms-txt#secure-training-(byob)
...
**URL:** llms-txt#this-command-returns-your-accounts/<account_id>/deployments/<deployment_id>---save-it-for-querying
...
**URL:** llms-txt#delete-reinforcement-fine-tuning-job
...
**URL:** llms-txt#get-evaluation-job-execution-logs-(stream-log-endpoint-+-tracing-ids).
...
**URL:** llms-txt#zero-data-retention
...
**URL:** llms-txt#create-a-new-llm-with-different-temperature
...
**URL:** llms-txt#delete-evaluation-job
...
**URL:** llms-txt#firectl-evaluator-revision-alias
...
**URL:** llms-txt#generate-rollouts-and-create-dataset

---

## Print tool call (verified) from the first response

**URL:** llms-txt#print-tool-call-(verified)-from-the-first-response
...
**URL:** llms-txt#firectl-supervised-fine-tuning-job-delete
...
**URL:** llms-txt#firectl-dpo-job-create
...
**URL:** llms-txt#firectl-api-key-delete
...
**URL:** llms-txt#firectl-secret-delete
...
**URL:** llms-txt#setup-fireworks-tracing
...
**URL:** llms-txt#why-am-i-experiencing-request-timeout-errors-and-slow-response-times-with-serverless-llm-models?
...
**URL:** llms-txt#output:-[chatcompletionmessagetoolcall(id='call_abc123',-function=function(arguments='{"location":"san-francisco"}',-name='get_weather'),-type='function')]
...
**URL:** llms-txt#iterative-reinforcement-learning-loop
...
**URL:** llms-txt#firectl-dpo-job-export-metrics
...
**URL:** llms-txt#what-factors-affect-the-number-of-simultaneous-requests-that-can-be-handled?
...
**URL:** llms-txt#using-predicted-outputs
...
**URL:** llms-txt#list-reinforcement-fine-tuning-jobs
...
**URL:** llms-txt#firectl-model-update
...
**URL:** llms-txt#wait-for-completion
...
**URL:** llms-txt#firectl-dpo-job-list
...
**URL:** llms-txt#single-turn-training-quickstart
...
**URL:** llms-txt#firectl-dpo-job-get
...
**URL:** llms-txt#download-a-single-dataset
...
**URL:** llms-txt#create-oidc-identity-provider
...
**URL:** llms-txt#cloud-integrations
...
**URL:** llms-txt#firectl-deployed-model-update
...
**URL:** llms-txt#firectl-identity-provider-create
...
**URL:** llms-txt#firectl-deployment-delete
...
**URL:** llms-txt#supervised-fine-tuning---vision
...
**URL:** llms-txt#firectl-deployed-model-get
...
**URL:** llms-txt#what-are-the-rate-limits-for-on-demand-deployments?
...
**URL:** llms-txt#training-prerequisites-&-validation
...
**URL:** llms-txt#firectl-account-get
...
**URL:** llms-txt#list-reinforcement-fine-tuning-steps
...
**URL:** llms-txt#resume-reinforcement-fine-tuning-job
...
**URL:** llms-txt#get-batch-inference-job
...
**URL:** llms-txt#firectl-model-create
...
**URL:** llms-txt#✅-round-to-larger-intervals-to-increase-cache-hits
...
**URL:** llms-txt#first,-create-an-initial-response
...
**URL:** llms-txt#convert-job-to-dictionary-for-easy-viewing
...
**URL:** llms-txt#resume-supervised-fine-tuning-job
...
**URL:** llms-txt#apply-lora-deployment-configuration-to-fireworks
...
**URL:** llms-txt#firectl-model-unload-lora
...
**URL:** llms-txt#firectl-reservation-list
...
**URL:** llms-txt#check-if-reasoning_content-from-first-turn-is-in-the-raw-prompt
...
**URL:** llms-txt#firectl-deployment-shape-version-list
