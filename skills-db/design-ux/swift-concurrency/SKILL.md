...
**Edge Cases & Fallbacks:** If settings unknown→ask developer to confirm before migration advice. If Core Data→reference core-data.md. If @preconcurrency needed→require documented invariant + follow-up ticket. If legacy closures→migration.md for conversion.
