...
# Dependencies
br dep add br-impl br-design
br dep add br-verbose br-impl
br dep add br-unit-tests br-impl
br dep add br-e2e-tests br-impl
```
...
br dep add br-ipc-tests br-ipc

# Fix cycle by introducing shared dependency
br dep remove br-state br-config
br create "Core types module" -p 1 -t task
br dep add br-config br-core-types
br dep add br-state br-core-types
```
