...
description: Identify hub vulnerabilities when analyzing infrastructure resilience or planning targeted interventions
category: systems-thinking-complexity
domain: network-science
status: active
confidence: high
source: Albert-László Barabási, Réka Albert (Nature, Science), Santa Fe Institute
---
...
- [Barabási–Albert model - Wikipedia](https://en.wikipedia.org/wiki/Barabási–Albert_model)
- [Scale-Free Networks: A Decade and Beyond - Albert-László Barabási](https://barabasi.com/media/pub_imports/files/303.pdf)
- [Network Science by Albert-László Barabási](http://networksciencebook.com/chapter/5)
- [Scale-free network - Wikipedia](https://en.wikipedia.org/wiki/Scale-free_network)
- [Comprehensive Analysis of Scale-Free Networks - Number Analytics](https://www.numberanalytics.com/blog/comprehensive-analysis-scale-free-networks-tech-era)
- [Robustness and Vulnerability of Scale-Free Random Graphs](https://projecteuclid.org/journals/internet-mathematics/volume-1/issue-1/Robustness-and-Vulnerability-of-Scale-Free-Random-Graphs/im/1057768558.full)
