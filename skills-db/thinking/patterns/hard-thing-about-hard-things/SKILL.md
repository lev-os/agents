...
description: Switch between peacetime and wartime leadership modes when facing existential threats requiring brutal honesty and hard decisions with no good options
tags: ["management", "leadership", "crisis-management", "decision-making", "executive-management"]
source: "Ben Horowitz - The Hard Thing About Hard Things"
practitioner: "Ben Horowitz (Andreessen Horowitz)"
score: 47
...
### Application
1. **Wartime mode engaged**: Shifted from empowerment to direct command-and-control on survival priorities
2. **Brutal honesty**: Told team exactly how bad things were—no spin, no false hope
3. **Focus on road**: Concentrated entirely on keeping top customers and core product alive, ignored everything else
4. **Psychological management**: Sought outside support (mentors, board) to maintain CEO stability while team needed strength
5. **People-first despite layoffs**: Made cuts once, deeply, with maximum transparency and support for those leaving
6. **Mission clarity**: Communicated single directive—survive to next funding milestone—eliminated all competing priorities
...
- [Farnam Street summary](https://fs.blog/the-hard-thing-about-hard-things/)
- [a16z book page](https://a16z.com/books/the-hard-thing-about-hard-things/)
