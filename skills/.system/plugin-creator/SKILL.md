---
name: plugin-creator
description: "Scaffolds Codex plugins with plugin.json plus optional skills, hooks, and marketplace entries. Use when creating a local Codex plugin or updating marketplace ordering metadata."
---
