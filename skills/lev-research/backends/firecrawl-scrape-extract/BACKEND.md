...
**firecrawl specializes in web scraping and content extraction. For search:**

| Tool | Specialty | Use When |
|------|-----------|----------|
| **firecrawl** (this) | Web scraping, site mapping, content extraction | Structured data, full-site crawls |
...
| **agent-browser** | Interactive web automation | Form filling, testing |

**Firecrawl's unique capabilities:**
- ✅ Clean markdown extraction from any page
- ✅ JavaScript rendering
- ✅ Site mapping (discover all URLs)
- ✅ Batch scraping with parallelization
- ✅ Structured data extraction
- ❌ Search queries (use brave/tavily/exa)
- ❌ Social sentiment (use grok-research)

**Integration pattern:**
```bash
# 1. Search for sources
firecrawl search "AI agents" --scrape -o .firecrawl/search.json

# 2. Extract URLs and scrape
jq -r '.data.web[].url' .firecrawl/search.json | \
  xargs -P 10 -I {} firecrawl scrape "{}" -o .firecrawl/{}.md

# 3. Deep research on findings
valyu research "AI agents architecture patterns" --turns 5
```
