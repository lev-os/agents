...
metadata: {"clawdbot":{"emoji":"🔬","requires":{"bins":["bun"],"env":["TAVILY_API_KEY","EXA_API_KEY"]},"primaryEnv":"TAVILY_API_KEY"}}
---
...
3. Use `lev get --scope=research` for integrated search

**Example:**
```bash
# Load exa + valyu
lev get "authentication patterns 2026" --scope=research
