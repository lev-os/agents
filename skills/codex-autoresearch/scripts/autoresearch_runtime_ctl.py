...
def build_parser() -> argparse.ArgumentParser:
    ...
    stop.add_argument("--run-tag")

    list_runs_parser = subparsers.add_parser("list-runs", help="List tagged autoresearch runs in a repo.")
...
def main() -> int:
    ...
    if args.command == "list-runs":
        print(json.dumps(list_runs(resolve_repo_path(args.repo)), indent=2, sort_keys=True))
        return 0
